package com.android.dayplanner.app.matches
...
interface RecycleViewActionsAndAsserts {
     ...
     */
    fun actionOnChildView(elementId: Int, action: ViewAction): ViewAction {
        return object : ViewAction {

            override fun getDescription(): String {
                return "Perform an action on the element with id $elementId inside" +
                        " a RecyclerView's item"
            }
            ...
            override fun perform(uiController: UiController, view: View) {
                view.let {
                    val element: View = it.findViewById(elementId)
